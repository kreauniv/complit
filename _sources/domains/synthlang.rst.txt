...
This way of defining mix lets us do a number of things with a single operator.
Simple addition of gens works, we can also subtract, or do a proportional mix.
